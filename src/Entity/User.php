...
class User
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Playlist::class, mappedBy: 'userCreator')]
    private Collection $playlists;

    /**
     * @var Collection<int, PlaylistSubscription>
     */
    #[ORM\OneToMany(targetEntity: PlaylistSubscription::class, mappedBy: 'userSub')]
     ...
     */
    #[ORM\OneToMany(targetEntity: SubscriptionHistory::class, mappedBy: 'userSub')]
    ...
    public function removePlaylist(Playlist $playlist): static
    {
        if ($this->playlists->removeElement($playlist)) {
            // set the owning side to null (unless already changed)
            if ($playlist->getUserCreator() === $this) {
                $playlist->setUserCreator(null);
            }
        }
    ...
    public function addPlaylistSubscription(PlaylistSubscription $playlistSubscription): static
    {
        if (!$this->playlistSubscriptions->contains($playlistSubscription)) {
            ...
            $playlistSubscription->setUserSub($this);
        }
    ...
    public function removePlaylistSubscription(PlaylistSubscription $playlistSubscription): static
    {
        if ($this->playlistSubscriptions->removeElement($playlistSubscription)) {
            // set the owning side to null (unless already changed)
            if ($playlistSubscription->getUserSub() === $this) {
                $playlistSubscription->setUserSub(null);
            }
        }
    ...
    public function addSubscriptionHistory(SubscriptionHistory $subscriptionHistory): static
    {
        if (!$this->subscriptionHistories->contains($subscriptionHistory)) {
            ...
            $subscriptionHistory->setUserSub($this);
        }
    ...
    public function removeSubscriptionHistory(SubscriptionHistory $subscriptionHistory): static
    {
        if ($this->subscriptionHistories->removeElement($subscriptionHistory)) {
            // set the owning side to null (unless already changed)
            if ($subscriptionHistory->getUserSub() === $this) {
                $subscriptionHistory->setUserSub(null);
            }
        }
