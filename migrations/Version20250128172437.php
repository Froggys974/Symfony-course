...
final class Version20250128172437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, user_comment_id INT DEFAULT NULL, media_id INT DEFAULT NULL, parent_comment_id INT DEFAULT NULL, content LONGTEXT NOT NULL, status_comment VARCHAR(255) NOT NULL, INDEX IDX_9474526C5F0EBBFF (user_comment_id), INDEX IDX_9474526CEA9FDD75 (media_id), INDEX IDX_9474526CBF2AF943 (parent_comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE playlist (id INT AUTO_INCREMENT NOT NULL, user_creator_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_D782112DC645C84A (user_creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE playlist_subscription (id INT AUTO_INCREMENT NOT NULL, playlist_id INT DEFAULT NULL, user_sub_id INT DEFAULT NULL, subscribed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_832940C6BBD148 (playlist_id), INDEX IDX_832940C603B89E4 (user_sub_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE subscription_history (id INT AUTO_INCREMENT NOT NULL, user_sub_id INT DEFAULT NULL, subscription_id INT DEFAULT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, INDEX IDX_54AF90D0603B89E4 (user_sub_id), INDEX IDX_54AF90D09A1887DC (subscription_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE watch_history (id INT AUTO_INCREMENT NOT NULL, user_watch_id INT DEFAULT NULL, media_id INT DEFAULT NULL, last_watched DATETIME NOT NULL, number_of_views INT NOT NULL, INDEX IDX_DE44EFD827486535 (user_watch_id), INDEX IDX_DE44EFD8EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE playlist ADD CONSTRAINT FK_D782112DC645C84A FOREIGN KEY (user_creator_id) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE playlist_subscription ADD CONSTRAINT FK_832940C603B89E4 FOREIGN KEY (user_sub_id) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE subscription_history ADD CONSTRAINT FK_54AF90D0603B89E4 FOREIGN KEY (user_sub_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE playlist DROP FOREIGN KEY FK_D782112DC645C84A');
        ...
        $this->addSql('ALTER TABLE playlist_subscription DROP FOREIGN KEY FK_832940C603B89E4');
        ...
        $this->addSql('ALTER TABLE subscription_history DROP FOREIGN KEY FK_54AF90D0603B89E4');
